...
func _init() -> void:
	...
	messages.append(Message.new("10:42 am", Message.Senders.LILLIAN , "heyy, just wondering if you've heard from nick? i'm worried about him...", Message.Emojis.NONE, 0, 1, 0.75, "Lillian"))
