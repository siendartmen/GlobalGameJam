...
func _init() -> void:
	...
	messages.append(Message.new("8:22 pm ", Message.Senders.QUAIL, "I still can't find anyone who knew the other person ", Message.Emojis.NONE, 0, 0.9, 0, "Quail spoke to various individuals."))
	messages.append(Message.new("8:23 pm ", Message.Senders.QUAIL, "short hair, apparently wearing like a dress shirt, nothing out of the blue", Message.Emojis.NONE, 0, 1, 0, "Sybil; bartender at the karaoke bar."))
